...
func (this *EntryController) GetListByFeed() {
	...
	//	entry.RequestGetList(this.GetInput())
	//
	//	feedId := this.Ctx.Input.Params[":feedId"]
	//	obs, err := resources.GetEntryList(feedId)
	//
	//	if err != nil {
...
func (this *EntryController) Get() {
	...
	//
	//	ob, err := resources.GetEntry(feedEntryId, feedId)
	//	if err != nil {
	//		this.Data["json"] = map[string]string{"result": err.Error(), "status": "error"}
	//	} else {
	//		this.Data["json"] = ob
...
func (this *EntryController) Post() {
	...
	//
	//	feedId := this.Ctx.Input.Params[":feedId"]
	//	id, err := resources.AddEntry(ob, feedId)
	//
	//	if err != nil {
	//		this.Data["json"] = map[string]string{"result": err.Error(), "status": "error"}
	//	} else {
...
func (this *EntryController) PostToFeed() {
	...
	entry.RequestPostToFeed(this.GetInput())
	entry.ResponsePostToFeed()
	this.ServeJson()
}
...
func (this *EntryController) Put() {
	...
	//	json.Unmarshal(data, &ob)
	//
	//	err := resources.UpdateEntry(feedEntryId, feedId, ob.Data)
	//	if err != nil {
	//		this.Data["json"] = map[string]string{"result": err.Error(), "status": "error"}
	//	} else {
...
func (this *EntryController) Delete() {
	...
	//	feedEntryId := this.Ctx.Input.Params[":feedEntryId"]
	//
	//	err := resources.DeleteEntry(feedEntryId, feedId)
	//
	//	if err != nil {
	//		this.Data["json"] = map[string]string{"result": err.Error(), "status": "error"}
	//	} else {
